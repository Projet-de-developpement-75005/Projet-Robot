...
robot = Robot(x=100, y=100, orientation=0, vitesse_gauche=0, vitesse_droite=0, diametre_roue=20, distance_roues=40)
...
if mode == "virtuel":
    arene = Arene(largeur=800, hauteur=600)
...
liste_strategies = []
for _ in range(4):
    strat_avancer = StrategieAvancer(distance=150, vitesse=10)
    strat_tourner = StrategieTourner(angle_degres=90, vitesse=3)
