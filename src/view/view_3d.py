...
class View3D:
    def __init__(self,arene,robot):
        ...
        self.robot_ent=Entity(model='cube',color=color.rgba(0,120,255,100),scale=(15,6,15),position=(robot.pos_x,hauteur_r/2,robot.pos_y))
        ...
        self.camera=EditorCamera(position=(largeur/2,350,hauteur/2-410),rotation=(45,0,0))
        camera.fov=70
    ...
    def update_affichage(self):
        ...
        self.robot_ent.rotation_z=-math.degrees(self.robot.angle_orientation)#ursina tourne par defaut dans le sens horaire 
